...
import { DepositActionsForm } from "@/features/deposit/form";
...
export default function DepositLayout() {
  ...
  const resetFilters = () => {
    setFilters({ status: "all", date: "all", search: "" });
    setQuery((p) => ({
      ...p,
      page: 1,
      status: undefined,
  ...
  return (
    <div className="space-y-6 mt-12">
            ...
            <div className="space-y-2 sm:col-span-2 lg:col-span-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="Amount, provider, game..."
      ...
      <GlobalDataTable<DepositRow>
        ...
        showActions={true}
        enableAdd={false}
        editModalTitle="Edit Deposit"
        renderForm={(p) => <DepositActionsForm {...p} allowStatusEdit={true} />}
        onAfterSuccess={() =>
          queryClient.invalidateQueries({ queryKey: ["deposits"] })
        }
      />
