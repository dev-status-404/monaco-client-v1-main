  ...
  return (
    <div className={cn("relative isolate w-full", className)}>
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 bg-black">
        {/* Large color blobs */}
        <div className="absolute -top-[320px] left-[8%] h-[900px] w-[900px] rounded-full bg-yellow-400/50 blur-[180px]" />
        <div className="absolute top-[25%] right-[0%] h-[1000px] w-[1000px] rounded-full bg-purple-400/18 blur-[200px]" />
